...
Service.connectedSessionId = nil
...
function Service.SendToServer(sessionId, rockstarId)
    Service.connectedSessionId = sessionId
                    ...
                    if code == 0 and response ~= "" then
                        ...
                        if #msgs > Service.lastMessageCount then
                            ...
                            for i = Service.lastMessageCount + 1, #msgs do
                                ...
                                local isOwnJoinLeave = (msg.sender == "System" and 
                                    (msg.message:find(myRockstarId .. " joined the chat") or 
                                     msg.message:find(myRockstarId .. " left the chat")))
                                
                                if msg.sender ~= myRockstarId and not isOwnJoinLeave then
